...
export default function AirportScreen() {
  ...
  const {searchFlightFrom, searchFlightTo} = useContext(AuthContext);
  ...
  const handleSearchFlight = () => {
    const data = {
      from: searchFlightFrom.from,
      to: searchFlightTo.to,
  ...
  return (
    <ImageBackground
      ...
      source={{
        uri: 'https://ak2.picdn.net/shutterstock/videos/1470292/thumb/1.jpg',
      }}>
      <View
      // justifyContent={'center'}
      // flex={1}
          ...
          <HStack justifyContent={'center'} marginTop={5}>
            <Pressable width="90%" onPress={handleSearchFrom}>
              <Input
                ...
                InputLeftElement={
                  <Icon
                    as={<MaterialIcons name="flight-takeoff" />}
                    size={5}
                    ml="4"
                    color="muted.400"
                  />
                }
                value={searchFlightFrom.from}
          ...
          <HStack justifyContent={'center'} marginTop={5}>
            <Pressable width="90%" onPress={handleSearchTo}>
              <Input
                ...
                InputLeftElement={
                  <Icon
                    as={<MaterialIcons name="flight-land" />}
                    size={5}
                    ml="4"
                    color="muted.400"
                  />
